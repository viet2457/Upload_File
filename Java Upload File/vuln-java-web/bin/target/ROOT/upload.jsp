...
<body>
    <div class="container">
        ...
        <%
            ...
            // String cmdOriginal = (String) request.getAttribute("cmdOriginal");
            // String cmdProcessed = (String) request.getAttribute("cmdProcessed");
        %>
        ...
        <% if (request.getAttribute("cmdOriginal") != null) { %>
            <div class="result">
                <h3>🛡️ Xử lý tham số cmd:</h3>
                <p><strong>Original:</strong> <code><%= request.getAttribute("cmdOriginal") %></code></p>
                <p><strong>Kết quả:</strong><br>
                    <%= request.getAttribute("cmdProcessed") %></p>
            </div>
        <% } %>
